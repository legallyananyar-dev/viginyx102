        ...
        {!hideNav && (
          <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-primary/10 shadow-2xl max-w-lg mx-auto rounded-t-2xl">
            <div className="grid grid-cols-4 h-16">
              ...
              <Link href="/vigiroom" className="flex flex-col items-center justify-center text-primary/70 hover:text-primary transition-colors duration-150 border-l border-primary/5">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 20.25a4.5 4.5 0 0 1 0-9h.75A6.75 6.75 0 1 1 19.5 15.75h-1.5" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75v6m-3-3h6" />
                </svg>
                <span className="text-[11px] font-bold">VigiRoom</span>
              </Link>
            </div>
          </nav>
        )}
