...
export const metadata: Metadata = {
  title: "Viginyx — Indian Pharmacist Suite",
  description: "Live OpenFDA drug search and Adverse Drug Reaction (ADR) reporting for Indian community pharmacists.",
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-neutral-bg text-foreground">
        ...
        {/* Main Content Container - constrained to mobile max-width for premium look on all screens */}
